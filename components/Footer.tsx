...
export function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/misoonastore/?_rdc=2&_rdr#',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/misoonastore/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@misoonastore',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@misoonastore',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
