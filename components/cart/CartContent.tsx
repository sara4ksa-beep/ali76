  ...
  return (
    ...
    >
          ...
          {items.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex gap-6 p-6 bg-gradient-to-r from-rose-50 to-pink-50 rounded-xl border-2 border-rose-100"
              >
                {product.images[0] && (
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                ...
                <div className="flex-1">
                  ...
                  <p className="text-rose-600 font-bold text-lg mb-4">${product.price.toFixed(2)}</p>
      ...
      <motion.div
        ...
        className="border-t-2 border-rose-200 pt-6"
      >
        <div className="flex justify-between items-center mb-6">
          <span className="text-2xl font-bold text-gray-800">{t('common.total')}:</span>
          <span className="text-3xl font-bold bg-gradient-to-r from-rose-600 to-rose-500 bg-clip-text text-transparent">
            ${getTotal().toFixed(2)}
          </span>
        </div>
        <Link href="/checkout">
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-700 hover:to-rose-600 text-white text-center font-semibold py-4 px-6 rounded-xl transition-all shadow-lg shadow-rose-200"
          >
