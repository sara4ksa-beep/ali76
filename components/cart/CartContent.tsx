  ...
  return (
    ...
    >
          ...
          {items.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex gap-6 p-6 bg-gradient-to-r from-orange-50 to-orange-50 rounded-xl border-2 border-orange-100"
              >
                {product.images[0] && (
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                ...
                <div className="flex-1">
                  ...
                  <p className="text-orange-600 font-bold text-lg mb-4">${product.price.toFixed(2)}</p>
      ...
      <motion.div
        ...
        className="border-t-2 border-orange-200 pt-6"
      >
        ...
        <Link href="/checkout">
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 text-white text-center font-semibold py-4 px-6 rounded-xl transition-all shadow-lg shadow-orange-200"
          >
