  ...
  const contactInfo = [
    {
      ...
      value: 'info@misoona.com',
      link: 'mailto:info@misoona.com',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {contactInfo.map((info, index) => (
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-rose-500 to-pink-500 rounded-full flex items-center justify-center mb-6 mx-auto text-white">
                  {info.icon}
                </div>
