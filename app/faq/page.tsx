      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mt-12 bg-gradient-to-r from-orange-600 to-orange-500 rounded-2xl shadow-xl p-8 text-center text-white"
          >
            <h3 className="text-2xl font-bold mb-4">{t('faq.stillHaveQuestions')}</h3>
            <p className="text-orange-100 mb-6">{t('faq.contactUs')}</p>
            <a
              href="/contact"
              className="inline-block bg-white text-orange-600 px-8 py-3 rounded-xl font-semibold hover:bg-orange-50 transition-colors"
            >
              {t('faq.contactButton')}
            </a>
          </motion.div>
