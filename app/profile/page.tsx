      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-rose-600 via-rose-500 to-pink-500 bg-clip-text text-transparent">
              {t('profile.title')}
            </h1>
            {!editing && (
              <motion.button
                ...
                className="px-6 py-3 bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-700 hover:to-rose-600 text-white font-semibold rounded-xl transition-all shadow-lg shadow-rose-200"
              >
                {t('profile.edit')}
              </motion.button>
            )}
            ...
            {editing ? (
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-rose-200 rounded-xl focus:border-rose-500 focus:ring-2 focus:ring-rose-200 outline-none transition-all"
                ...
                <div className="flex gap-4">
                  <motion.button
                    ...
                    disabled={saving}
                    className="flex-1 bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-700 hover:to-rose-600 text-white font-semibold py-3 px-6 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-rose-200"
                  >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xl font-semibold text-rose-600 uppercase">{user.role}</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
            ...
            <div className="space-y-6">
              {orders.map((order, index) => (
                <motion.div
                  ...
                  className="border-2 border-rose-100 rounded-xl p-6 hover:shadow-lg transition-all"
                >
